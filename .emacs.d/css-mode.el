...
(defvar cssm-indent-level 1 "The indentation level inside @media rules.")
...
(defvar cssm-properties
  '("font-family" "font-style" "font-variant" "font-weight"
    ...
    "border-collapse" "border-spacing" "border-left-color" "border-left-style"
...
(defvar cssm-font-lock-keywords
  (list
   ...
   (cons "#[_-a-zA-Z0-9]*" font-lock-function-name-face)
