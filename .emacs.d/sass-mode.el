...
(defconst sass-font-lock-keywords-1
	(list
	 ;; CSS color hash
	 '("#[a-f0-9][a-f0-9][a-f0-9][a-f0-9][a-f0-9][a-f0-9]"  0 font-lock-keyword-face)
	 ;; CSS id tag 
	 '("#[a-zA-Z_]*"  0 font-lock-constant-face append)
	 ;; Ruby-style symbols attributes 
	 '(":[a-zA-Z0-9-]*"  0 font-lock-variable-name-face append)))
